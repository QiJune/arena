...
func NewLogsCommand() *cobra.Command {
	...
	command.Flags().StringVar(&trainingType, "type", "", "The training type to show logging, the possible option is tfjob, mpijob, pytorchjob, elasticdljob, etjob, horovodjob or standalonejob. (optional)")
